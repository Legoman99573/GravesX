...
```shell
mvn install:install-file -Dfile=libs/authlib-7.0.61-graves.jar -DgroupId=com.mojang -DartifactId=authlib -Dversion=7.0.61-graves -Dpackaging=jar
mvn install:install-file -Dfile=libs/libby-2.0.1-graves2.jar -DgroupId=com.alessiodp -DartifactId=libby -Dversion=2.0.1-graves2 -Dpackaging=jar
...
mvn install:install-file -Dfile=libs/minitranslator-2.6.1-graves.jar -DgroupId=com.github.imDaniX -DartifactId=MiniTranslator -Dversion=v2.6.1-graves -Dpackaging=jar
```

...
/**
 * @deprecated Use {@link dev.cwhead.GravesX.event.GraveCompassAddEvent} instead. Will be removed in 2027.4.9.1.
...
public class GraveCompassAddEvent extends dev.cwhead.GravesX.event.GraveCompassAddEvent {
    ...
    private static @NotNull Player requirePlayer(@NotNull Entity entity) {
        ...
        throw new GravesXIllegalArgumentException("GraveCompassAddEvent requires a Player; got " + entity.getType());
    }
